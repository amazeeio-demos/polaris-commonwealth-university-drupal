# Base template for Drupal projects hosted on Lagoon with a change
...
To see similar projects with additional services, please visit https://github.com/amazeeio-demos and to find out more about the services, please visit the documentation at https://docs.lagoon.sh/lagoon
...
1. Checkout this project repo and confirm the path is in Docker's file sharing config - https://docs.docker.com/docker-for-mac/#file-sharing
    ...
    ```bash
    git clone https://github.com/amazeeio-demos/polaris-commonwealth-university-drupal.git polaris-commonwealth-university-drupal && cd $_
    ```
...
4. Visit the new site @ `http://polaris-commonwealth-university-drupal.docker.amazee.io`
...
6. Visit the new site @ `http://polaris-commonwealth-university-drupal.lndo.site`
